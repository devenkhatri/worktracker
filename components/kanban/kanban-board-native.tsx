...
import { KanbanColumnNative } from './kanban-column-native';

interface KanbanBoardNativeProps {
  tasks: Task[];
...
export function KanbanBoardNative({ tasks, onTaskStatusUpdate, onTaskOpen }: KanbanBoardNativeProps) {
